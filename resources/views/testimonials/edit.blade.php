    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('testimonials.update', $testimonial->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$testimonial->translate('az')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$testimonial->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$testimonial->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$testimonial->translate('ru')->title}}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$testimonial->translate('az')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$testimonial->translate('en')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$testimonial->translate('ru')->content}}</textarea>
                                    @if($errors->first('ru_content')) <small class="form-text text-danger">{{$errors->first('ru_content')}}</small> @endif
                                </div>

                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px;" src="{{asset('storage/' . $testimonial->image)}}" class="uploaded_image" alt="{{$testimonial->image}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        ...
                                        <option value="0" {{$testimonial->is_active == false ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>

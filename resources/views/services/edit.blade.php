    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('services.update', $service->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$service->translate('az')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$service->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$service->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$service->translate('ru')->title}}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$service->translate('az')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$service->translate('en')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$service->translate('ru')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        <option value="1" {{$service->is_active == true ? 'selected' : ''}}>Active</option>
                                        <option value="0" {{$service->is_active == false ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>

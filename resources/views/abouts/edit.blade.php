    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('abouts.update', $about->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$about->translate('az')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$about->translate('az')->title}}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$about->translate('az')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$about->translate('en')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$about->translate('ru')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        <option value="1" {{$about->is_active == true ? 'selected' : ''}}>Active</option>
                                        <option value="0" {{$about->is_active == false ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>

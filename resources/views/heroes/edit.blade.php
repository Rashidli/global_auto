    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('heroes.update', $hero->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$hero->translate('az')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$hero->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$hero->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$hero->translate('ru')->title}}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_az" class="form-control" type="text" name="az_content" >{{$hero->translate('az')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_en" class="form-control" type="text" name="en_content" >{{$hero->translate('en')->content}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="editor_ru" class="form-control" type="text" name="ru_content">{{$hero->translate('ru')->content}}</textarea>
                                    @if($errors->first('ru_content')) <small class="form-text text-danger">{{$errors->first('ru_content')}}</small> @endif
                                </div>

                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px;" src="{{asset('storage/' . $hero->image)}}" class="uploaded_image" alt="{{$hero->image}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        <option value="1" {{$hero->is_active == true ? 'selected' : ''}}>Active</option>
                                        <option value="0" {{$hero->is_active == false ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>
